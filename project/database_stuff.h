...
bool createAccount(const QString& firstName,const QString& lastName,const QString& email,const QString& username,const QString& password,const QString& mailingAddress,const QString& physicalAddress,const QString& phoneNumber);
...
bool createServiceProvider(const QString& accountID,const QString& SPPhone,const QString& SPEmail,const QString& SPWebsite,const QString& SPNormalHours,const QString& SPEHours,const QString& SPServicesProvided,const QString& SPHourlyRate,const QString& SPBaseRate,const QString& SPLocationKey);
...
bool createLandlord(const QString& accountID, const QString& LLPhone, const QString& LLEmail, const QString& LLWebsite);
bool llAddLocation(const QString& accountID, const QString& locHours, const QString& locAddress, const QString& locDays, const QString& locPhone, const QString& locEmail, const QString& locWebsite);
